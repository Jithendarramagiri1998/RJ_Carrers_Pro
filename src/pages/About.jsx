  ...
  return (
    <>
      ...
      <main className="bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] min-h-screen text-white px-6 md:px-16 py-20 overflow-hidden relative">
        ...
        {/* About Section */}
        <section className="max-w-6xl mx-auto relative z-10 py-12">
          <motion.div
          ...
          >
            ...
            <div className="lg:w-2/3">
              <motion.h1
                ...
                className="text-4xl md:text-5xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-blue-500"
              >
                Ramagiri Jithendar
              </motion.h1>
              ...
              >
                <a
                  href="#contact"
                  className="inline-flex items-center bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-medium rounded-full px-8 py-3 transition-all duration-300 shadow-lg hover:shadow-xl"
                >
                  Get Career Guidance
        ...
        {/* Skills Section */}
        <section className="max-w-6xl mx-auto relative z-10 py-12 mt-16">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">
              Technical Expertise
            </h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-semibold text-blue-400 mb-6">Core DevOps Skills</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold text-cyan-400 mb-6">Additional Competencies</h3>
                <div className="space-y-6">
        ...
        {/* Philosophy Section */}
        <section className="max-w-4xl mx-auto relative z-10 py-12 mt-16">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="bg-gray-800/50 backdrop-blur-md rounded-3xl p-8 md:p-12 border border-gray-700"
          >
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-white mb-2">Practical Over Theoretical</h4>
        ...
        {/* CTA Section */}
        <section className="max-w-4xl mx-auto relative z-10 py-20 text-center">
          <motion.div
            initial={{ opacity: 0, scale: 0.95 }}
            whileInView={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="bg-gradient-to-r from-blue-600/20 to-cyan-600/20 rounded-3xl p-12 border border-blue-500/20 backdrop-blur-md"
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a
                href="tel:+9177880996"
                className="inline-flex items-center justify-center bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-medium rounded-full px-8 py-4 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
