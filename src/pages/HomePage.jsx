...
import { SiHomepage } from "react-icons/si"; // ✅ Correct
...
const HomePage = () => {
  ...
  return (
    <main className="bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] min-h-screen text-white px-6 md:px-16 py-20 overflow-hidden relative">
      ...
      {/* Contact Ribbon */}
      <div className="absolute top-0 left-0 right-0 bg-gradient-to-r from-blue-600 to-cyan-600 py-3 px-6 text-sm font-medium flex flex-col sm:flex-row justify-center items-center gap-2 sm:gap-6 z-50">
        <a href="tel:+91 9177880996" className="flex items-center hover:text-white transition-colors">
          <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
          </svg>
          +91 9177880996
        </a>
        <a href="mailto:ramgirjithendar17@gmail.com" className="flex items-center hover:text-white transition-colors">
          <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
          </svg>
          ramgirjithendar17@gmail.com
        </a>
      </div>
      ...
      {/* Services Section */}
      <section id="services" className="max-w-7xl mx-auto relative z-10 pb-40" ref={ref}>
        <motion.div
          variants={container}
          initial="hidden"
          animate={controls}
        ...
        >
          <motion.h2
            variants={item}
            className="text-4xl md:text-5xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400"
          >
      ...
      {/* Contact Section */}
      <section id="contact" className="max-w-5xl mx-auto relative z-10 pb-40">
        <motion.div
          initial={{ opacity: 0, scale: 0.95 }}
          whileInView={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.6 }}
          viewport={{ once: true, margin: "-100px" }}
          className="bg-gradient-to-r from-blue-600/20 to-cyan-600/20 rounded-3xl p-12 text-center border border-blue-500/20 backdrop-blur-md"
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-300">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-left max-w-4xl mx-auto">
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href="tel:9177880996" className="text-white hover:text-blue-300 transition-colors">+91 9177880996</a>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="bg-blue-500/10 p-2 rounded-lg mr-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:ramgirjithendar17@gmail.com" className="text-white hover:text-blue-300 transition-colors">ramgirjithendar17@gmail.com</a>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="bg-blue-500/10 p-2 rounded-lg mr-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-cyan-400 mb-4">Quick Contact Form</h3>
              <form className="space-y-4">
                ...
                <button 
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-medium rounded-lg px-6 py-3 transition-all duration-300 shadow-lg hover:shadow-xl"
                >
                  Send Message
                </button>
              </form>
      ...
      >
        <a
          ...
          className="w-16 h-16 bg-gradient-to-r from-green-500 to-teal-500 rounded-full flex items-center justify-center shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-110"
