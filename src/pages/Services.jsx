      ...
      <main className="bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] min-h-screen text-white px-6 md:px-16 py-24 overflow-hidden relative">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {services.map((service, index) => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className="bg-gray-800/50 backdrop-blur-md rounded-xl p-8 border border-gray-700 hover:border-blue-500/30 transition-all duration-300"
              >
                <div className="flex items-start mb-6">
                  <div className="bg-gradient-to-br from-blue-600/20 to-cyan-600/20 p-3 rounded-lg mr-4">
                    {service.icon}
                  </div>
                  <div>
          ...
          <motion.div
            ...
            className="mt-20 bg-gradient-to-r from-blue-600/20 to-cyan-600/20 rounded-2xl p-12 text-center border border-blue-500/20 backdrop-blur-md"
          >
